...
**20% 压缩比分析:** 6 个 MC 任务平均 Accuracy 0.490 vs 论文 0.49，差异在 ±0.05 以内，属于 lm_eval 版本 / prompt 模板差异。GSM8K 论文值仅 0.05，压缩后数学推理能力基本丧失。MathQA 通过本地 Parquet 数据集解决了 datasets 4.1.1 兼容性问题。
